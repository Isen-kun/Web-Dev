...
function draw()
{
	...
	image(robbieKrayImg, cecilKarpinskiPosX, cecilKarpinskiPosY-269);
	image(pawelKarpinskiImg, cecilKarpinskiPosX+293, cecilKarpinskiPosY-269);
	image(bonesKarpinskiImg, cecilKarpinskiPosX+586, cecilKarpinskiPosY-269);
	image(rockyKrayImg, cecilKarpinskiPosX+293, cecilKarpinskiPosY);
	image(annaKarpinskiImg, cecilKarpinskiPosX+586, cecilKarpinskiPosY);
