...
Officer: 7129607
CaseNum: 303-0-96972321-7129607
...
The first safe is in Torvald’s office. Crack it by doing the following:
	...
	- Make secureSafeValueA equal to 20

	Whilst the mouse is being dragged:
	- Make secureSafeValueA equal to 19

	Whilst the mouse is moving:
	- Make secureSafeValueA equal to 16

	When any key is pressed:
	- Make secureSafeValueA equal to 11

	When any key is released:
	- Make secureSafeValueB equal to 6

	Whilst the mouse is being dragged:
	- Make secureSafeValueB equal to 76

	When the mouse button is pressed:
	- Make secureSafeValueB equal to 31

	When any key is pressed:
	- Make secureSafeValueB equal to 18
...
var secureSafeValueA;
var secureSafeValueB;
...
function draw()
{
	...
	drawDial(200, secureSafeValueA, 28);
	pop();

	//Draw the lever
	push();
	translate(width - 125,256);
	drawLever(secureSafeValueB);
	pop();
